...
use clap::Parser;
use header_completer::compilation_database::{
    CompilationDatabaseEntryForDeserialize, CompilationDatabaseForDeserialize,
};
...
fn main() -> Result<(), header_completer::error::Error> {
    ...
    serde_json::to_writer_pretty(
        ...
        &command_table
            .get_entries()
            .into_iter()
            .map(CompilationDatabaseEntryForDeserialize::from_entry)
            .collect::<Vec<_>>(),
    )
